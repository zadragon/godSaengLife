...
const PointInfoPop = () => {
    return (
        <>
            <div
                className="bg-neutral-100 rounded-2xl w-[343px] h-[480px] relative overflow-hidden"
                style={{ position: 'fixed', top: '50%', left: '50%', zIndex: 50, transform: 'translate(-50%,-50%)' }}
            >
                <div className="flex flex-col gap-3 items-start justify-start h-[380px] absolute left-[calc(50%_-_155.5px)] top-[100px]">
