...
const CommunityList = () => {
    return (
        <div>
            ...
            <S.SearchBox>
                <div>
                    <div className="bg-neutral-100 rounded-lg p-3 flex flex-row gap-2 items-center justify-start shrink-0 w-full h-12 relative">
                        <svg
                        ...
                        <div
                            className="text-neutral-400 text-left relative flex-1"
                            style={{
